...
public class EsDemoService {
	...
	public SearchResponse search(String index, String startDateStr, String endDateStr) throws Exception {

		BoolQueryBuilder booleanQueryBuilder = QueryBuilders.boolQuery();
		SearchSourceBuilder sourceBuilder = new SearchSourceBuilder().size(200);
		SearchRequest searchRequest = new SearchRequest(index);
	...
	public SearchResponse searchQuery(String index, SysLogPageQuery sysLogPageQuery) throws Exception {
	...
	public Page<SysLog> searchPageQuery(String index, SysLogPageQuery sysLogPageQuery) throws Exception {
	...
	public SearchResponse getAggregationDemo(String indexName, SysLogPageQuery sysLogPageQuery) throws Exception {
