...
public class FileUtils {
    ...
    public static String readToStringRelativePath(String relativePath) throws IOException {
        String encoding = "UTF-8";
        File file = new File(
                FileUtils.class.getClassLoader().getResource("").getPath() + File.separatorChar + relativePath);
...
//                str.append(new String(filecontent, 0, len, encoding));
//            }
            return IOUtils.toString(in);
//            in.close();
        } catch (FileNotFoundException e) {
            //e.printStackTrace();
            //System.out.println("从jar中读取：" + relativePath);
            InputStream in = FileUtils.class.getClassLoader().getResourceAsStream(relativePath);
...
//                }
//                in.close();
            //	System.out.println("文件内容：" + new String(filecontent, encoding));
            return IOUtils.toString(in);
...
//            }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getFormatSize(2199023255552D));
